...
def taxicab(a, b):
    ...
    """
    "*** YOUR CODE HERE ***"
    dist_street = abs(street(a) - street(b))
    dist_avenue = abs(avenue(a) - avenue(b))
    return dist_avenue + dist_street
...
def squares(s):
    ...
    """
    "*** YOUR CODE HERE ***"
    return [round(element ** 0.5) for element in s if round(element ** 0.5) == element ** 0.5]
